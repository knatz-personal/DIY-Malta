<%@ Page Title="" Language="C#" MasterPageFile="~/masters/SiteSkeleton.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="UI.contact" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TITLE" runat="server">
    Contact
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="MAINCONTENTPLACEHOLDER">
        <div class="form-box" style=" width: 90%;margin: 0 auto;">
        <article>
            <section>
                <h2>article section h2</h2>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sodales urna non
                    odio egestas tempor. Nunc vel vehicula ante. Etiam bibendum iaculis libero, eget
                    molestie nisl pharetra in. In semper consequat est, eu porta velit mollis nec. Curabitur
                    posuere enim eget turpis feugiat tempor. Etiam ullamcorper lorem dapibus velit suscipit
